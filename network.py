...
def main():
    ...
    network = Network()
    network.nodes[0].mark_position('start')
    network.add_path(0, 1, 65)
    network.add_path(1, 2, 6)
    network.add_path(2, 3, 55)
    network.add_path(3, 4, 39)
    network.add_path(4, 5, 12)
    network.add_path(3, 5, 16)
    network.add_path(5, 6, 8)
    network.add_path(6, 7, 38)
    network.add_path(7, 8, 34)
    network.nodes[8].mark_position('end')
