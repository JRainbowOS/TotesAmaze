...
def main():
    ...
    network.add_path(0, 2, 2)
    network.add_path(1, 3, 2)
    network.add_path(2, 3, 3)
    network.add_path(1, 4, 3)
    network.add_path(2, 5, 1)
    network.add_path(5, 6, 2)
    network.add_path(4, 7, 7)
    network.add_path(3, 8, 3)
    network.add_path(8, 10, 2)
    network.add_path(9, 10, 1)
    network.add_path(6, 9, 1)
    network.add_path(9, 11, 3)
    network.add_path(5, 11, 6)
    network.add_path(10, 12, 1)
    network.add_path(10, 13, 3)
    network.add_path(11, 13, 3)
    network.add_path(7, 12, 5)
    network.add_path(7, 14, 1)
    network.add_path(4, 14, 4)
    network.add_path(12, 15, 2)
    network.add_path(13, 15, 2)
    network.nodes[15].mark_position('end')
