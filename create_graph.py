...
class Maze:
    ...
    def bmp_to_graph(self):
        ...
        network.add_node(start_id, row=start_row, col=start_col)
        network.nodes[0].row = start_row
        network.nodes[0].col = start_col
        ...
        network.add_node(end_id, row=end_row, col=end_col)
    ...
    def overlay_solution(self, rows, cols):
        """ Creates grey (127) path on grid """
        # grid, _, _ = self.get_bmp()      
